...
PieceInfo Board::getWhitePawns() const {
    return this->white_pawns_;
}

PieceInfo Board::getBlackPawns() const {
    return this->black_pawns_;
}

PieceInfo Board::getWhiteKnights() const {
    return this->white_knights_;
}

PieceInfo Board::getBlackKnights() const {
    return this->black_knights_;
}

PieceInfo Board::getWhiteBishops() const {
    return this->white_bishops_;
}

PieceInfo Board::getBlackBishops() const {
    return this->black_bishops_;
}

PieceInfo Board::getWhiteRooks() const {
    return this->white_rooks_;
}

PieceInfo Board::getBlackRooks() const {
    return this->black_rooks_;
}

PieceInfo Board::getWhiteQueens() const {
    return this->white_queens_;
}

PieceInfo Board::getBlackQueens() const {
    return this->black_queens_;
}

PieceInfo Board::getWhiteKing() const {
    return this->white_king_;
}

PieceInfo Board::getBlackKing() const {
