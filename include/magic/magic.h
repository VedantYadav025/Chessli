...
constexpr std::array<BitBoard, 64> getRookMasks() {
...
inline std::array<std::array<BitBoard, 4096>,64> getRookAttacks() {
  ...
  std::ifstream file("rook_attacks.txt");
...
inline const std::array<BitBoard, 64> rook_relevant_bits = {
    12, 11, 11, 11, 11, 11, 11, 12, 11, 10, 10, 10, 10, 10, 10, 11,
    11, 10, 10, 10, 10, 10, 10, 11, 11, 10, 10, 10, 10, 10, 10, 11,
    11, 10, 10, 10, 10, 10, 10, 11, 11, 10, 10, 10, 10, 10, 10, 11,
    11, 10, 10, 10, 10, 10, 10, 11, 12, 11, 11, 11, 11, 11, 11, 12};

constexpr std::array<BitBoard, 64> rook_masks = getRookMasks();
const auto rook_attacks = getRookAttacks();

inline const std::array<BitBoard, 64> bishop_relevant_bits = {
...
constexpr std::array<BitBoard, 64> getBishopMasks() {
  BitBoard attacks = 0ULL;
...
constexpr std::array<BitBoard, 64> bishop_masks = getBishopMasks();

inline std::array<std::array<BitBoard, 4096>, 64> getBishopAttacks() {
    
  std::array<std::array<BitBoard, 4096>, 64> bishop_attacks{};
...
const std::array<std::array<BitBoard, 4096>, 64> bishop_attacks = getBishopAttacks();
