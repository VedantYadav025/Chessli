...
void Board::makeMove(const Move& move) {
  ...
  const Piece piece_at_from = m_piece_at_array[static_cast<int>(from)]; // Black Pawn
...
BitBoard Board::allWhitePiecesBitBoard() const {
...
BitBoard Board::allBlackPiecesBitBoard() const {
